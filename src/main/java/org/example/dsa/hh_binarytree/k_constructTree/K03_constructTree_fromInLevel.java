package org.example.dsa.hh_binarytree.k_constructTree;
...
public class K03_constructTree_fromInLevel {
	...
	private static Node constructTree(Node root, int inStart, int inEnd) {
		...
		// traverse LEVEL[] and check if LEVEL[i] exists in IN[]
		// if yes, mark that position because that is the root of the current tree
