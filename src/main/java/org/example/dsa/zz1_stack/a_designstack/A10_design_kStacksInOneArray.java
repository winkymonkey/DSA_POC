 ...
 * Implementation of kStacks should use only one array
 * (i.e. k stacks should use the same array for storing elements)
 * 
...
public class A10_design_kStacksInOneArray {
	/*
	 * TODO
	 */
}
